...
export const bottomLinksData = (
...
) => [
  {
    ...
    label: '도움말',
    path: '/help',
    textClass: `${primaryTextColor}/50 text-body-sm-500 font-medium`,
    hoverTextClass: `${primaryTextColor} text-body-sm-500 font-medium`,
  ...
  },
  {
    ...
    label: '계정 로그인',
    path: '/login',
    textClass: 'text-[#CC8889] text-body-sm-500 font-medium',
    hoverTextClass: 'text-[#FF084A] text-body-sm-500 font-medium',
    iconSize: 'w-[15px] h-[15px]',
    heightClass: 'h-[38px]',
