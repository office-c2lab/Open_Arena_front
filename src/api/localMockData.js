...
export function getLocalProblemBundle(problemId) {
  ...
  return {
    ...
    problem: {
      ...
      description: `${title} 문제의 상세 설명입니다. 문제에서 제공하는 상황과 제한 조건을 읽고, AI와의 대화를 통해 목표에 가까운 응답을 만들어야 합니다.문제의 상세 설명입니다. 문제에서 제공하는 상황과 제한 조건을 읽고, AI와의 대화를 통해 목표에 가까운 응답을 만들어야 합니다.문제의 상세 설명입니다. 문제에서 제공하는 상황과 제한 조건을 읽고, AI와의 대화를 통해 목표에 가까운 응답을 만들어야 합니다.문제의 상세 설명입니다. 문제에서 제공하는 상황과 제한 조건을 읽고, AI와의 대화를 통해 목표에 가까운 응답을 만들어야 합니다.문제의 상세 설명입니다. 문제에서 제공하는 상황과 제한 조건을 읽고, AI와의 대화를 통해 목표에 가까운 응답을 만들어야 합니다.문제의 상세 설명입니다. 문제에서 제공하는 상황과 제한 조건을 읽고, AI와의 대화를 통해 목표에 가까운 응답을 만들어야 합니다.문제의 상세 설명입니다. 문제에서 제공하는 상황과 제한 조건을 읽고, AI와의 대화를 통해 목표에 가까운 응답을 만들어야 합니다.문제의 상세 설명입니다. 문제에서 제공하는 상황과 제한 조건을 읽고, AI와의 대화를 통해 목표에 가까운 응답을 만들어야 합니다.문제의 상세 설명입니다. 문제에서 제공하는 상황과 제한 조건을 읽고, AI와의 대화를 통해 목표에 가까운 응답을 만들어야 합니다.문제의 상세 설명입니다. 문제에서 제공하는 상황과 제한 조건을 읽고, AI와의 대화를 통해 목표에 가까운 응답을 만들어야 합니다.문제의 상세 설명입니다. 문제에서 제공하는 상황과 제한 조건을 읽고, AI와의 대화를 통해 목표에 가까운 응답을 만들어야 합니다.문제의 상세 설명입니다. 문제에서 제공하는 상황과 제한 조건을 읽고, AI와의 대화를 통해 목표에 가까운 응답을 만들어야 합니다.문제의 상세 설명입니다. 문제에서 제공하는 상황과 제한 조건을 읽고, AI와의 대화를 통해 목표에 가까운 응답을 만들어야 합니다.`,
