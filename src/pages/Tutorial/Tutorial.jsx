...
function PanelPreviewSection({
  ...
  return (
    <section className="space-y-5 border-b border-[#DDE3EA] pb-12">
      ...
      <div className="no-scrollbar relative overflow-x-auto rounded-[10px] bg-[#E5EAF0] p-6">
        <div
    ...
    <>
      ...
      <PanelPreviewSection
        ...
        steps={[
          ...
          '성공 판정 이후에도 사용 토큰을 확인하고, 더 효율적인 풀이를 고민할 수 있다는 점을 기억합니다.',
        ]}
        cautions={[
  ...
  return (
    <>
      <section className="border-b border-[#DDE3EA] pb-10">
        ...
        <ul className="mt-4 space-y-3">
          {[
            '챌린지 정보 영역과 채팅 영역이 각각 어떤 역할을 하는지 구분합니다.',
      ...
      <section className="space-y-5 border-b border-[#DDE3EA] pb-12">
        <div className="border-b border-[#DDE3EA] pb-3">
          ...
          <SectionDescription
            ...
            items={[
              '처음 진입하면 아직 대화가 시작되지 않은 상태이므로 채팅 영역에는 대화 시작 안내가 보입니다.',
              '진행 순서는 보통 챌린지 정보 영역 확인, 채팅 영역에서 대화 시작, 조건을 만족했다고 판단되면 제출, 결과 모달 확인 순서로 이어집니다.',
              '챌린지 정보 영역은 풀이 기준과 사용 토큰을 보여주고, 채팅 영역은 실제 대화와 제출 행동을 담당한다고 이해하면 됩니다.',
            ]}
            steps={[
              '전체 화면에서 챌린지 정보 영역과 채팅 영역의 위치를 먼저 확인합니다.',
              '챌린지 정보 영역의 목표와 성공조건을 읽은 뒤, 채팅 영역의 입력창이 어디 있는지 확인합니다.',
              '챌린지 정보 영역 하단의 사용 토큰 카드 위치를 확인합니다.',
              '아래 개별 영역 설명으로 내려가 각 영역을 따로 살펴봅니다.',
            ]}
            cautions={[
              '채팅 영역부터 바로 입력하기보다, 챌린지 정보 영역의 목표와 성공조건을 먼저 확인해야 풀이 방향이 흔들리지 않습니다.',
              '제출하기 전에 채팅 영역의 응답만 보지 말고, 사용 토큰과 성공조건 충족 여부를 함께 확인하는 습관을 들이는 것이 좋습니다.',
            ]}
          />
        </div>
