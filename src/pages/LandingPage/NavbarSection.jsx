        ...
        <nav className="hidden items-center gap-6 md:flex">
          {items.map(item => (
            <a
              key={item.href}
              href={item.href}
              className="text-body text-[#57534e] transition hover:text-[#171717]"
            >
              {item.label}
            </a>
          ))}
