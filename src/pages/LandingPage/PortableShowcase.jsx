    ...
    >
      ...
      <section className="pb-24">
        <div className="mx-auto flex max-w-4xl flex-col items-center px-6 text-center">
          <p className="mb-6 text-card-title font-medium tracking-wide text-amber-100/82 sm:text-section-title"></p>
          <a
            href="https://apc.aiarena.kr/"
            className="group inline-flex cursor-pointer items-center gap-2 rounded-full border border-amber-200/24 bg-amber-100/90 px-8 py-3 text-body-lg font-strong text-black shadow-[0_10px_22px_rgba(255,214,153,0.12)] transition duration-300 hover:-translate-y-0.5 hover:scale-[1.02] hover:border-amber-100/50 hover:bg-amber-50 hover:shadow-[0_14px_28px_rgba(255,214,153,0.2)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-500"
          >
