            ...
            <div className="flex flex-col gap-6 lg:pl-6">
              <motion.div className="max-w-xl space-y-4" {...SECTION_TITLE_REVEAL}>
                <SectionTitle
                  ...
                  desc={
                    <>
                      ARENA는 사용자가 남긴 대화 전체를 <br />
                      Auto Judge 단계에서 먼저 수집하고 정리합니다.
                      <br />
                      필요한 로그를 모아 3개의 Judge Model이 <br />
                      동시에 읽을 수 있는 평가 상태로 넘겨 줍니다.
                    </>
                  }
                />
              </motion.div>
              ...
              >
                단순히 결과만 보여주는 대신, <br />
                실제로 분석이 진행 중인 로딩 경험까지 포함해 <br />
                하나의 심사 흐름처럼 체감할 수 있도록 구성했습니다.
              </motion.div>
            </div>
          </div>
