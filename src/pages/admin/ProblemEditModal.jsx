  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex justify-center items-center z-50">
      <div className="w-[700px] max-h-[90vh] overflow-y-auto bg-[#0B021C] text-white p-8 rounded-xl border border-[#FF4854] shadow-xl">
        ...
        <h2 className="text-2xl font-bold text-[#FF4854] mb-6">
          문제 수정 / 삭제
        </h2>
        ...
        <Input label="Temperature" type="number" name="temperature" value={form.temperature} onChange={handleChange} />
