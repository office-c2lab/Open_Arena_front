  ...
  return (
    <div className="w-full flex flex-col gap-6 mt-10">
      <div className="flex items-center justify-between gap-4">
        <h1 className="text-page-title font-strong text-[#FF4854]">문제 활성/비활성 관리</h1>
        ...
        {filteredProblems.map(p => (
          ...
          >
            ...
            <div className="flex items-center justify-between">
              <span className="text-card-title font-strong">{p.title}</span>

              <ToggleSwitch enabled={p.is_active} onToggle={() => toggleMutation.mutate(p.id)} />
            </div>

            {/* 둘째 줄 */}
            <div className="text-body-lg font-medium text-gray-500 pl-1">
