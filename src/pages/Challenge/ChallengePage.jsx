// /src/pages/ChallengePage.jsx (Zustand 통합 최종 버전)
...
export default function ChallengePage() {
  ...
  useEffect(() => {
    if (challengeId) {
      // 컴포넌트 진입 시 상태 초기화 (다른 챌린지로 이동 시 대비)
      resetSessionState(); 
  ...
  }, [challengeId, mutate, problemId, teamId]); 
  ...
  if (sessionId) {
    ...
    // Challenge 컴포넌트는 이제 prop 없이 스토어에서 sessionId를 직접 가져옵니다.
    return <Challenge />;
  }
