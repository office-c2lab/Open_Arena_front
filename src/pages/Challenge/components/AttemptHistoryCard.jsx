 ...
 */
const AttemptHistoryCard = ({ attemptNumber, isSuccess, isSubmitted, promptSummary, onClick, isActive }) => { 
    ...
    return (
        ...
        >
            ...
            <div className="flex justify-between items-center flex-shrink-0 h-[36px]">
                ...
                >
                    <span className="body-small" style={{ color: isActive ? COLOR_WHITE : COLOR_PURPLE_LIGHT }}>
                        {attemptNumber}
                    </span>
                </div>
                {/* 성공/실패/미제출 태그 */}
